...
sa.compatMode?sa.documentElement:sa.body;var da=(new Ad(Z.clientWidth,Z.clientHeight)).round()}catch(Y){da=new Ad(-12245933,-12245933)}sa=da;da={};var ea=void 0===ea?A:ea;Z=new Oe;ea.SVGElement&&ea.document.createElementNS&&Z.set(0);y=Hd();y["allow-top-navigation-by-user-activation"]&&Z.set(1);y["allow-popups-to-escape-sandbox"]&&Z.set(2);ea.crypto&&ea.crypto.subtle&&Z.set(3);ea.TextDecoder&&ea.TextEncoder&&Z.set(4);ea=Pe(Z);da.bc=ea;da.bih=sa.height;da.biw=sa.width;da.brdim=p.join();b=b.j;b=(da.vis=
...
if(2!=g.i)return xa(g,0);f=za(g);throw yj(f,a,"",-1);})}
...
function gl(a,b,c,d){var e,f,g,h,k,l;return x(function(m){switch(m.i){case 1:return f=null!=(e=Error().stack)?e:"",w(m,el(),2);case 2:g=m.j;if(!g)throw h=zj("openDbImpl",a,b),R("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),ij(h),h;nj(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:fl(a);wa(m,3);return w(m,Wk(k,g),5);case 5:return w(m,Ok(k.actualName,b,d),6);case 6:return m.return(m.j);case 3:return l=za(m),wa(m,7),w(m,Xk(k.actualName,g),9);case 9:xa(m,
...
var Pm=new Om,Qm=new Om,Rm=!0,Sm=A.ytLoggingTransportGELQueue_||new Map;B("ytLoggingTransportGELQueue_",Sm);var Tm=A.ytLoggingTransportGELProtoQueue_||new Map;B("ytLoggingTransportGELProtoQueue_",Tm);var Um=A.ytLoggingTransportTokensToCttTargetIds_||{};B("ytLoggingTransportTokensToCttTargetIds_",Um);var Vm=A.ytLoggingTransportTokensToJspbCttTargetIds_||{};B("ytLoggingTransportTokensToJspbCttTargetIds_",Vm);var Wm={};function Xm(){var a=C("yt.logging.ims");a||(a=new Hm,B("yt.logging.ims",a));return a}
function Ym(a,b){R("web_all_payloads_via_jspb")&&Mh(new kj("transport.log called for JSON in JSPB only experiment"));if("log_event"===a.endpoint){Zm(a);var c=$m(a);if(R("use_new_in_memory_storage")){Wm[c]=!0;var d={cttAuthInfo:c,isJspb:!1};Xm().storePayload(d,a.payload);an(b,[],c,!1,d)}else d=Sm.get(c)||[],Sm.set(c,d),d.push(a.payload),an(b,d,c)}}
function bn(a,b){if("log_event"===a.endpoint){Zm(void 0,a);var c=$m(a,!0);if(R("use_new_in_memory_storage")){Wm[c]=!0;var d={cttAuthInfo:c,isJspb:!0};Xm().storePayload(d,a.payload.toJSON());an(b,[],c,!0,d)}else d=Tm.get(c)||[],Tm.set(c,d),a=a.payload.toJSON(),d.push(a),an(b,d,c,!0)}}
function an(a,b,c,d,e){d=void 0===d?!1:d;a&&(Nm=new a);a=hi("tvhtml5_logging_max_batch")||hi("web_logging_max_batch")||100;var f=T(),g=d?Qm.l:Pm.l;b=b.length;e&&(b=Xm().getSequenceCount(e));b>=a?R("background_thread_flush_logs_due_to_batch_limit")?Wh(function(){cn({writeThenSend:!0},R("flush_only_full_queue")?c:void 0,d)},0):cn({writeThenSend:!0},R("flush_only_full_queue")?c:void 0,d):10<=f-g&&(dn(d),d?Qm.l=f:Pm.l=f)}
function en(a,b){R("web_all_payloads_via_jspb")&&Mh(new kj("transport.logIsolatedGelPayload called in JSPB only experiment"));if("log_event"===a.endpoint){Zm(a);var c=$m(a),d=new Map;d.set(c,[a.payload]);b&&(Nm=new b);return new Of(function(e,f){Nm&&Nm.isReady()?fn(d,Nm,e,f,{bypassNetworkless:!0},!0):e()})}}
function gn(a,b){if("log_event"===a.endpoint){Zm(void 0,a);var c=$m(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(Nm=new b);return new Of(function(e){Nm&&Nm.isReady()?hn(d,Nm,e,{bypassNetworkless:!0},!0):e()})}}
...
function dn(a){a=void 0===a?!1:a;if(R("web_gel_timeout_cap")&&(!a&&!Pm.i||a&&!Qm.i)){var b=Wh(function(){cn({writeThenSend:!0},void 0,a)},6E4);
a?Qm.i=b:Pm.i=b}window.clearTimeout(a?Qm.j:Pm.j);b=P("LOGGING_BATCH_TIMEOUT",hi("web_gel_debounce_ms",1E4));R("shorten_initial_gel_batch_timeout")&&Rm&&(b=Lm);b=Wh(function(){cn({writeThenSend:!0},void 0,a)},b);
a?Qm.j=b:Pm.j=b}
...
function sn(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||T());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;R("enable_unknown_lact_fix_on_html5")&&zm();a=Cm();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};R("log_sequence_info_on_gel_web")&&d.ja&&(a=e.context,b=d.ja,b={index:tn(b),groupKey:b},a.sequence=b,d.lb&&delete rn[d.ja]);(d.vb?en:Ym)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,ea:d.ea},c)}
function un(a){cn(void 0,void 0,void 0===a?!1:a)}
function tn(a){rn[a]=a in rn?rn[a]+1:0;return rn[a]}
;var vn=A.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",vn);function wn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;P("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:vm;b=void 0===b?{}:b;var d=Math.round(b.timestamp||T());I(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Cm();d=new th;I(d,1,b.timestamp||!isFinite(e)?-1:e);if(R("log_sequence_info_on_gel_web")&&b.ja){e=b.ja;var f=tn(e),g=new sh;I(g,2,f);I(g,1,e);J(d,sh,3,g);b.lb&&delete vn[b.ja]}J(a,th,33,d);(b.vb?gn:bn)({endpoint:"log_event",payload:a,cttAuthInfo:b.cttAuthInfo,ea:b.ea},c)}
...
K=y.stack||v.j||"Not available";if(K.startsWith(H+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=y.lineNumber||"Not available",ob=y.fileName||"Not available",yc=K,ya=0;if(v.hasOwnProperty("args")&&v.args&&v.args.length)for(var sa=0;sa<v.args.length&&!(ya=Hn(v.args[sa],"params."+sa,p,ya),500<=ya);sa++);else if(v.hasOwnProperty("params")&&v.params){var Z=v.params;if("object"===typeof v.params)for(q in Z){if(Z[q]){var da="params."+q,ea=Jn(Z[q]);p[da]=ea;ya+=da.length+ea.length;if(500<ya)break}}else p.params=
Jn(Z)}if(On.length)for(var Y=0;Y<On.length&&!(ya=Hn(On[Y],"params.context."+Y,p,ya),500<=ya);Y++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:H,lineNumber:O,fileName:ob,stack:yc,params:p,sampleWeight:1},Tj=Number(v.columnNumber);isNaN(Tj)||(S.lineNumber=S.lineNumber+":"+Tj);if("IGNORED"===v.level)m=0;else a:{for(var Uj=Dn(),Vj=t(Uj.V),Sf=Vj.next();!Sf.done;Sf=Vj.next()){var Wj=Sf.value;if(S.message&&S.message.match(Wj.Sb)){m=Wj.weight;
...
break}}}S.params||(S.params={});var dk=Dn();S.params["params.errorServiceSignature"]="msg="+dk.V.length+"&cb="+dk.T.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));sb("sample").constructor!==rb&&(S.params["params.fconst"]="true");var ua=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ua);if(0!==ua.sampleWeight&&!Kn.has(ua.message)){if("ERROR"===h){En.da("handleError",
ua);if(R("record_app_crashed_web")&&0===Nn&&1===ua.sampleWeight)if(Nn++,R("errors_via_jspb")){var Yf=new rh;I(Yf,1,1);if(!R("report_client_error_with_app_crash_ks")){var ek=new mh;I(ek,1,ua.message);var fk=new nh;J(fk,mh,3,ek);var gk=new oh;J(gk,nh,5,fk);var hk=new ph;J(hk,oh,9,gk);J(Yf,ph,4,hk)}var ro=Yf,ik=new uh;id(ik,rh,20,vh,ro);wn(ik)}else{var jk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(jk.systemHealth={crashData:{clientError:{logMessage:{message:ua.message}}}});
xn("appCrashed",jk)}Mn++}else"WARNING"===h&&En.da("handleWarning",ua);if(R("kevlar_gel_error_routing"))a:{var Zf=void 0,$f=void 0,Oc=h,Q=ua;if(R("errors_via_jspb")){if(Qn())$f=void 0;else{var ac=new jh;I(ac,1,Q.stack);Q.fileName&&I(ac,4,Q.fileName);var Pa=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Pa.length&&(1!==Pa.length||isNaN(Number(Pa[0]))?2!==Pa.length||isNaN(Number(Pa[0]))||isNaN(Number(Pa[1]))||(I(ac,2,Number(Pa[0])),I(ac,3,Number(Pa[1]))):I(ac,2,Number(Pa[0])));var vb=
new mh;I(vb,1,Q.message);I(vb,3,Q.name);I(vb,6,Q.sampleWeight);"ERROR"===Oc?I(vb,2,2):"WARNING"===Oc?I(vb,2,1):I(vb,2,0);var ag=new kh;I(ag,1,!0);id(ag,jh,3,lh,ac);var wb=new gh;I(wb,3,window.location.href);for(var kk=P("FEXP_EXPERIMENTS",[]),bg=0;bg<kk.length;bg++){var lk=wb,so=kk[bg];Nc(lk);dd(lk,5,2,!1).push(so)}var cg=Gh();if(!Hh()&&cg)for(var mk=t(Object.keys(cg)),xb=mk.next();!xb.done;xb=mk.next()){var nk=xb.value,dg=new ih;I(dg,1,nk);dg.setValue(String(cg[nk]));kd(wb,4,ih,dg)}var eg=Q.params;
...
void 0;else{var Pc={stackTrace:Q.stack};Q.fileName&&(Pc.filename=Q.fileName);var Qa=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Qa.length&&(1!==Qa.length||isNaN(Number(Qa[0]))?2!==Qa.length||isNaN(Number(Qa[0]))||isNaN(Number(Qa[1]))||(Pc.lineNumber=Number(Qa[0]),Pc.columnNumber=Number(Qa[1])):Pc.lineNumber=Number(Qa[0]));var ig={level:"ERROR_LEVEL_UNKNOWN",message:Q.message,errorClassName:Q.name,sampleWeight:Q.sampleWeight};"ERROR"===Oc?ig.level="ERROR_LEVEL_ERROR":"WARNING"===
Oc&&(ig.level="ERROR_LEVEL_WARNNING");var to={isObfuscated:!0,browserStackInfo:Pc},bc={pageUrl:window.location.href,kvPairs:[]};P("FEXP_EXPERIMENTS")&&(bc.experimentIds=P("FEXP_EXPERIMENTS"));var jg=Gh();if(!Hh()&&jg)for(var uk=t(Object.keys(jg)),yb=uk.next();!yb.done;yb=uk.next()){var vk=yb.value;bc.kvPairs.push({key:vk,value:String(jg[vk])})}var kg=Q.params;if(kg){var wk=t(Object.keys(kg));for(yb=wk.next();!yb.done;yb=wk.next()){var xk=yb.value;bc.kvPairs.push({key:"client."+xk,value:String(kg[xk])})}}var yk=
P("SERVER_NAME"),zk=P("SERVER_VERSION");yk&&zk&&(bc.kvPairs.push({key:"server.name",value:yk}),bc.kvPairs.push({key:"server.version",value:zk}));Zf={errorMetadata:bc,stackTrace:to,logMessage:ig}}var Ak=Zf;if(!Ak)break a;xn("clientError",Ak)}if("ERROR"===Oc||R("errors_flush_gel_always_killswitch"))b:if(R("migrate_events_to_ts"))c:{if(R("web_fp_via_jspb")&&(un(!0),!R("web_fp_via_jspb_and_json")))break c;un()}else{if(R("web_fp_via_jspb")&&(un(!0),!R("web_fp_via_jspb_and_json")))break b;un()}}if(!R("suppress_error_204_logging")){var zb=
ua,Qc=zb.params||{},ab={urlParams:{a:"logerror",t:"jserror",type:zb.name,msg:zb.message.substr(0,250),line:zb.lineNumber,level:h,"client.name":Qc.name},postParams:{url:P("PAGE_NAME",window.location.href),file:zb.fileName},method:"POST"};Qc.version&&(ab["client.version"]=Qc.version);if(ab.postParams){zb.stack&&(ab.postParams.stack=zb.stack);for(var Bk=t(Object.keys(Qc)),lg=Bk.next();!lg.done;lg=Bk.next()){var Ck=lg.value;ab.postParams["client."+Ck]=Qc[Ck]}var mg=Gh();if(mg)for(var Dk=t(Object.keys(mg)),
ng=Dk.next();!ng.done;ng=Dk.next()){var Ek=ng.value;ab.postParams[Ek]=mg[Ek]}var Fk=P("SERVER_NAME"),Gk=P("SERVER_VERSION");Fk&&Gk&&(ab.postParams["server.name"]=Fk,ab.postParams["server.version"]=Gk)}si(P("ECATCHER_REPORT_HOST","")+"/error_204",ab)}try{Kn.add(ua.message)}catch(yo){}Ln++}}}}}else throw Zb;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function mo(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
